...
export default function Resume() {
  ...
  return (
    <div className="pt-32 pb-20 px-6 md:px-12 mx-auto max-w-[900px] font-sans text-black/[0.65] dark:text-white/[0.65] [&_strong]:text-black/75 dark:[&_strong]:text-white/75 [&_strong]:font-semibold leading-relaxed">
