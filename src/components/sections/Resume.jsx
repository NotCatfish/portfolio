...
export default function Resume() {
  ...
  return (
    <div className="pt-32 pb-20 px-6 md:px-12 mx-auto max-w-[900px] font-sans text-neutral-700 dark:text-neutral-400 [&_strong]:text-neutral-900 dark:[&_strong]:text-white [&_strong]:font-semibold leading-relaxed">
